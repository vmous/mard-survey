...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% VM: Don't know if we should start with this Gnutell specific material maybe
% it needs to go to the respective paragraph of dece.unstructured bellow.
...
\begin{figure}[ht]
\centering
\subfigure[Centralized ({\sl SETI@Home} or {\sl Napster}). Peers
query the centralized 
...
%% VM The next part was previously at the end of this paragraph and didn't seem
%% to fit right there. I moved it here since it is a theoretical optimality
%% definition used by some authors we review and I think it can help the reader
%% better understand what problem. Also I have rewritten it.
%%
The ratio of the physical distance (e.g., in hops) a query travels to
...
%% VM: This section has a lot of information that I belieave are worth
%% mentioning on the paper's conclusion section. We say for example why no
%% approach we reviewed is best of all (cause it is an NP-Hard problem); or why
%% virtual coordinate approaches will never be a reliable tool in today's
%% Internet. Also it doesn't add much to the purpose of this section that is to
%% say what motivated us to write the paper. If you also agree we can move it.
...
%% VM: If we move the above though we have to mention why all solutions are
%% heuristic.
