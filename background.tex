...
For over a decade, excitement over the immense potential of P2P systems
...
A key disadvantage of the unstructured approach
...
%% TODO: add references for the above line.
...
Early incarnations of the overlay protocols did not make use of the
...
The topology mismatch problem is exacerbated by the extremely large
amounts of traffic
