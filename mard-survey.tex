...
\begin{abstract}
Peer-to-peer (\p) systems have enjoyed immense attention and have been
...
load balancing, quality of service, scalability, and others.  
Unfortunately, weaknesses of early deployments of \p\ systems prevented 
applications from leveraging these features.  
One major weakness, identified early on, is the topology
mismatch problem between the overlay network and the underlying IP topology.
This mismatch can impose an extraordinary amount of unnecessary stress on
network resources and can adversely affect the scalability of applications
built atop \p\ systems.  
...
proposed solutions and discuss the advantages, disadvantages, and novelties
introduced by each solution.  
Finally, we provide an analysis as well as pictorial comparisons 
of the proposed solutions since we aim to offer a comprehensive 
reference for system architects, developers, and researchers in the field.
% in an attempt to provide a comprehensive quick one-stop-shop
% reference for anyone interested in the topic, from researchers and students,
