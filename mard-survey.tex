...
\author{Vassilis Moustakas,
        H\"useyin Akcan,
        Mema Roussopoulos,
        and~Alex Delis,~\IEEEmembership{Member,~IEEE}% <-this % stops a space
\thanks{Vassilis Moustakas, Mema Roussopoulos and Alex Delis are with the Department
of Informatics and Telecommunications, National and Kapodistrian University of Athens,
GR15784, Athens, Greece (e-mail: vsmoustakas@gmail.com, mema@di.uoa.gr, ad@di.uoa.gr.}% <-this % stops a space
\thanks{H\"useyin Akcan is with the Department of Software Engineering,
Izmir University of Economics, Izmir, Turkey (email: huseyin.akcan@ieu.edu.tr).}% <-this % stops a space
\thanks{Manuscript received June 30, 2015; revised July 31, 2015.}}
...
% The paper headers
\markboth{IEEE COMMUNICATION SURVEYS \& TUTORIALS, VOL. XX, NO. YY, Z QUARTER YYYY}%
{Moustakas \MakeLowercase{\textit{et al.}}: Alleviating the Topology Mismatch Problem in Distributed Overlay Networks}
...
widely deployed on the Internet for well ov, er a decade.
They are implemented via an overlay network abstraction, on top 
of the Internet's best-effort IP infrastructure. 
...
Unfortunately, inherent weaknesses of early deployments of \p\ systems, prevented 
...
\begin{IEEEkeywords}
Distributed systems, peer-to-peer architectures, p2p, overlay network,
topology awareness
\end{IEEEkeywords}
...
%
% IN CASE REVIEWERS POINT OUT THAT WE SHOULD ADD THOSE AS WELL.
%
...
\begin{IEEEbiography}{Vassilis Moustakas}
Biography text here.
\end{IEEEbiography}
...
\begin{IEEEbiography}{H\"useyin Akcan}
Biography text here.
\end{IEEEbiography}

\begin{IEEEbiography}{Mema Roussopoulos}
Biography text here.
\end{IEEEbiography}

\begin{IEEEbiography}{Alex Delis}
Biography text here.
\end{IEEEbiography}
