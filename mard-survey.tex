...
\begin{abstract}
Peer-to-peer (P2P) systems have enjoyed immense attention and have been
widely deployed on the Internet for well over a decade.  P2P systems 
are implemented via
an overlay network abstraction on top of the best-effort IP infrastructure
of the Internet. These systems offer a plethora
of desirable features to distributed applications that are built on top of them
including anonymity, high availability and robustness, load balancing,
quality of service, scalability, and others.  Unfortunately, weaknesses of
early deployments of P2P systems prevented applications from leveraging 
these features.  One major weakness, identified early on, is the topology
...
and structured P2P systems.   
We provide a fine-grained categorization of the
proposed solutions and discuss the advantages, disadvantages, and novelties
introduced by each solution.  Finally, we provide an analysis and pictorial 
comparisons 
of the proposed solutions in an attempt to provide a quick one-stop-shop
