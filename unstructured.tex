...
medium \\
\emph{Local Indices} &
% efficiency is enhanced greatly since data pointers are replicated acros the
% network
high &
...
low &
% Reduced search scope makes this not really scalable
low
\end{tabular}
\end{center}
...
medium &
% tracerout and hop counts and calculation from both the tracker and the peers
...
\emph{Efficiency} & \emph{Overhead} & \emph{Scalability} \\
\hline
% The technique is partitions the system reducing the search efficiency
low &
