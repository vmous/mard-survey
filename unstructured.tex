...
are proposed: \emph{uniform}, \emph{proportional}, and
...
square-root model they attempt to find the golden ratio in ``between'', by
...
{\sl Gnutella}'s query flooding method but incurs up to two
...
{\sl BitTorrent}'s chocking/unchocking mechanism. A peer unchokes its $4$
closest, in terms of 
...
compared to popular {\sl BitTorrent} implementations.
