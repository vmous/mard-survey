...
routing tables as a whole, seem to be the elements more used in the
literature throught the years that this area is researched.
%%%
...
replication strategies to refine its results. What looks a bit different
compared the trends in unstructred systems is the fact that, here, researchers
...
to even harder trade-offs which, in most cases, are 
